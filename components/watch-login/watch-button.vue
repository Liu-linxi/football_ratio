	...
	export default{
		props:{
			...
			bgColor:{
				//按钮背景颜色
				type: String,
				default: "linear-gradient(to right,rgba(216,24,40,0.7), rgba(216,24,40,0.6))",
			},
			fontColor:{
				//按钮字体颜色
				type: String,
...
<style>
	...
	.dlbutton {
		...
		width:601rpx;
		height:100rpx;
		background:linear-gradient(to right, rgba(216,24,40,0.7), rgba(216,24,40,0.6));
	...
	.buttonBorder{
	    border: none ;
	    border-radius: 2.5rem ;
	    -webkit-box-shadow: 0 0 60rpx 0 rgba(216,24,40,.2) ;
	    box-shadow: 0 0 60rpx 0 rgba(216,24,40,.2) ;
